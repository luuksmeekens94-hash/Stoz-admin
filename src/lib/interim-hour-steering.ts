...
export const INTERIM_HOUR_TARGETS: readonly InterimHourTarget[] = [
  ...
  },
  {
    ...
    activityCode: "A5.1",
    targetHours: 8,
    rationale: "Eerste kennisdeling en borgingsvoorbereiding horen al zichtbaar te zijn; de meeste verspreiding volgt in de tweede helft.",
  },
  {
    budgetLineKey: "PRACTICE_IMPLEMENTATION",
    title: "Praktijkmanagement · implementatie",
    ...
    activityCode: "A6.1",
    targetHours: 12,
    rationale: "Inrichting van monitoring, nulmeting en evaluatievoorbereiding start vóór de bredere implementatie.",
  },
  {
